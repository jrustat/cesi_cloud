...
# Get latest Amazon Linux 2023 AMI if ami_id is not provided
  ...
  user_data = base64encode(<<-EOF
    ...
    <body>
        <div class="container">
            ...
            <div class="info">Welcome to the web application!</div>
            <div class="info">
                <span class="highlight">Instance: $INSTANCE_ID</span>
            </div>
            <div class="info">
                <span class="highlight">AZ: $AVAILABILITY_ZONE</span>
                <span class="highlight">IP: $PRIVATE_IP</span>
            </div>
